...
<head>
    ...
    <script type="text/javascript" src="content/signalling/script/signalling.js"></script>
    <style type="text/css">
		...
		<div class="ml15 mr15 div-open">
			...
			<div class="mt10 animated fadeInDown pr" style="z-index:101">
				...
				<div class="inlininput mr10">
					...
					<input id="txtPhone" type="text" class="w100" placeholder="" >
				</div>
				<div class="inlininput mr10">
				...
				<div id="interfacepanel" class="sel_wrap w150 mb10 mr10 dragdownlist"  style="overflow: visible;">
					...
					<!--<select class="select" name="">
						...
						<option value="1">S1-U</option>
						<option value="2">S1-MME</option>
						<option value="3">SGS</option>
						<option value="4">S11</option>
					</select>-->
			...
			<div class="panel panel-default animated fadeInUp">
			  <div class="pl15 pr15 pt10 pb10 clearfix">
				  ...
				  <div class="pull-right">
				  	<a href="#" class="btn btn-danger mr10">问题定界</a>
				  	<a href="#" class="btn btn-success mr10">GIS查看</a>
