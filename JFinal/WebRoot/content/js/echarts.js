...
! function(e) {
    ...
    s.version = "2.2.5", s.dependencies = {
        zrender: "2.1.0"
    }, s.init = function(t, n) {
        var a = e("zrender");
    ...
    var i = e("./tool/util"),
        ...
        h = {},
        d = {};
    d.version = "2.1.0", d.init = function(e) {
        var t = new c(a(), e);
        return h[t.id] = t, t
        ...
        V = {
            ...
            click: function(e) {
                if (u(e)) {
                    ...
                    (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, c.CLICK, e), this._mousemoveHandler(e)
                }
            },
            dblclick: function(e) {
                if (u(e)) {
                    ...
                    var t = this._lastHover;
                    (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, c.DBLCLICK, e), this._mousemoveHandler(e)
                }
            },
                ...
                if (u(e)) {
                    ...
                    this.painter.eachBuildinLayer(function(t) {
                        ...
                        if (t.zoomable) {
                            t.__zoom = t.__zoom || 1;
                            var l = t.__zoom;
                            l *= i, l = Math.max(Math.min(t.maxZoom, l), t.minZoom), i = l / t.__zoom, t.__zoom = l, r[0] -= (a - r[0]) * (i - 1), r[1] -= (o - r[1]) * (i - 1), t.scale[0] *= i, t.scale[1] *= i, t.dirty = !0, n = !0, s.stop(e)
                        }
                    }), n && this.painter.refresh(), this._dispatchAgency(this._lastHover, c.MOUSEWHEEL, e), this._mousemoveHandler(e)
                }
            },
            mousemove: function(e) {
                if (u(e) && !this.painter.isLoading()) {
                    ...
                    var n = "default";
                    if (this._draggingTarget) this.storage.drift(this._draggingTarget.id, t, i), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++;
                    ...
                    this._draggingTarget || this._hasfound && this._lastHover.draggable ? n = "move" : this._hasfound && this._lastHover.clickable && (n = "pointer"), this.root.style.cursor = n, this._dispatchAgency(this._lastHover, c.MOUSEMOVE, e), (this._draggingTarget || this._hasfound || this.storage.hasHoverShape()) && this.painter.refreshHover()
                }
            },
            mouseout: function(e) {
                if (u(e)) {
            ...
            mouseup: function(e) {
                u(e) && (e = this._zrenderEventFixed(e), this.root.style.cursor = "default", this._isMouseDown = 0, this._mouseDownTarget = null, this._dispatchAgency(this._lastHover, c.MOUSEUP, e), this._processDrop(e), this._processDragEnd(e))
            },
            touchstart: function(e) {
                u(e) && (e = this._zrenderEventFixed(e, !0), this._lastTouchMoment = new Date, this._mobileFindFixed(e), this._mousedownHandler(e))
            },
            touchmove: function(e) {
                u(e) && (e = this._zrenderEventFixed(e, !0), this._mousemoveHandler(e), this._isDragging && s.stop(e))
            },
            touchend: function(e) {
                if (u(e)) {
                    e = this._zrenderEventFixed(e, !0), this._mouseupHandler(e);
                    var t = new Date;
                    t - this._lastTouchMoment < c.touchClickDelay && (this._mobileFindFixed(e), this._clickHandler(e), t - this._lastClickMoment < c.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && s.stop(e)), this._lastClickMoment = t), this.painter.clearHover()
                }
            }
        },
        U = function(e, t, o) {
    ...
    return t.prototype = {
        ...
        _reformLogValue: function() {
            ...
            this._min = i.dataMin,
                this._max = i.dataMax, this._valueList = i.tickList, this._dataMappingMethods = i.dataMappingMethods, this._reformLabelData(i.labelFormatter)
        },
