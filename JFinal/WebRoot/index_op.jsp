...
<div id="mask" class="mask" style="text-align: center">
    ...
    <img src="./content/images/skypeUploading.gif" style="position: absolute;width: 200px; padding-top:229px; z-index:999"/>
</div>
</body>
<!-- JQ与BOOTSTRAP组件库 -->
...
<script type="text/javascript">
    ...
    $("#sd").val(now.getFullYear() + "/" + (month < 10 ? ("0" + month) : month) + "/" + now.getDate() + " 00");
    $("#ed").val(now.getFullYear() + "/" + (month < 10 ? ("0" + month) : month) + "/" + now.getDate() + " 23");
    //    $("#mask").hide();
